...
export const projectService = {
    ...
    getById: (id: string): Promise<Project> => {
        return useMock ? mockApi.getProject(id) : apiClient.get(`/projects/${id}`).then(res => res.data);
    },
    ...
    update: (id: string, data: Partial<Project>): Promise<Project> => {
        return useMock ? mockApi.getProject(id).then(p => Object.assign(p!, data)) : apiClient.put(`/projects/${id}`, data).then(res => res.data);
    },
